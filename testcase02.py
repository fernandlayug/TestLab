...
df = pd.read_excel('ALSResponses.xlsx')  # Replace 'your_dataset.xlsx' with the path to your Excel file
...
# Apply PCA
pca = PCA(n_components=4)  # You can choose the number of components you want
