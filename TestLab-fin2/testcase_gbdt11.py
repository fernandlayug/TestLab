...
joblib.dump(encoder, 'encoder_6.pkl')
...
scaler_data.to_excel('scaler_6.xlsx', index=False)
...
encoder_df.to_excel('encoder_6.xlsx', index=False)
...
joblib.dump(best_xgb, 'best_xgb_model_11.pkl')
