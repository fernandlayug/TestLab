...
data = pd.read_excel('selected_data_2.xlsx')
...
joblib.dump(scaler, 'scaler_4.pkl')
...
scaler_data.to_excel('scaler_4.xlsx', index=False)
...
joblib.dump(best_xgb, 'best_xgb_model_10.pkl')
