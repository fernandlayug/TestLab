...
df = pd.read_excel('balanced_data_3.xlsx')
...
selected_features_df.to_excel('selected_features_2.xlsx', index=False)
...
selected_data.to_excel('selected_data_2.xlsx', index=False)
